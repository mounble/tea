...
var thing01 = document.getElementById("chabing");
var thing02 = document.getElementById("chaguan1");
var thing03 = document.getElementById("chazhan");
var thing04 = document.getElementById("chasheng");
...
var op03 = document.createElement("div");
...
words.style.backgroundImage = "url(./make_tea/7.png)";
setTimeout("background_change(7)", 3000);
op_move1(1);
op_move2(2);
op_move3(1);
//文字提示图片改变
...
function op_move1(n) {
    ...
    op.addEventListener("touchstart", (e) => {
        ...
        op1.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + mouse_startY + "px;left: " + mouse_startX + "px;background-image: url(./make_tea/chahu.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
        ...
        op1.addEventListener("touchend", (e) => {
            if (op1.offsetLeft > area.offsetLeft && op1.offsetTop > area.offsetTop) {
                if (op1.offsetLeft < area.offsetLeft + 40 && op1.offsetTop < area.offsetTop + 40) {
                    ...
                    op2.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + thingY + "px;left: " + thingX + "px;background-image: url(./make_tea/chahu.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
                    bg.appendChild(op2);
                    dragflag[n] = 1;
                }
            }
...
function op_move2(n) {
    ...
    op.addEventListener("touchstart", (e) => {
        ...
        op.style.display = "none";
        big_box.style.display = "block";
        op01.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + mouse_startY + "px;left: " + mouse_startX + "px;background-image: url(./make_tea/chazhan.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
        ...
        op01.addEventListener("touchend", (e) => {
            if (op01.offsetLeft > area.offsetLeft && op01.offsetTop > area.offsetTop) {
                if (op01.offsetLeft < area.offsetLeft + 40 && op01.offsetTop < area.offsetTop + 40) {
                    ...
                    big_box.style.display = "none";
                    op02.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + thingY + "px;left: " + thingX + "px;background-image: url(./make_tea/chazhan.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
                    bg.appendChild(op02);
...
function op_move3(n) {
    ...
    op.addEventListener("touchstart", (e) => {
        ...
        op.style.display = "none";
        big_box.style.display = "block";
        op03.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + mouse_startY + "px;left: " + mouse_startX + "px;background-image: url(./make_tea/chamo2.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
        big_box.appendChild(op03);
        op03.addEventListener("touchstart", (e) => {
            baby_statrtX = op03.offsetLeft;
            baby_statrtY = op03.offsetTop;
            mouse0_startX = e.targetTouches[0].pageX;
            mouse0_startY = e.targetTouches[0].pageY;
        })
        op03.addEventListener("touchmove", (e) => {
            if (isdrag == 1) {
                op03.style.left = baby_statrtX + e.targetTouches[0].pageX - mouse0_startX + "px";
                op03.style.top = baby_statrtY + e.targetTouches[0].pageY - mouse0_startY + "px";
            }
        })
        op03.addEventListener("touchend", (e) => {
            if (op03.offsetLeft > area.offsetLeft && op03.offsetTop > area.offsetTop) {
                if (op03.offsetLeft < area.offsetLeft + 40 && op03.offsetTop < area.offsetTop + 40) {
                    isdrag = 0;
                    thingX = op03.offsetLeft;
                    thingY = op03.offsetTop;
                    big_box.style.display = "none";
                    op03.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + thingY + "px;left: " + thingX + "px;background-image: url(./make_tea/chamo2.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
                    bg.appendChild(op03);
                    black.style.display = "block";
                    show.style.backgroundImage = "url(./make_tea/7tiaogao.gif)";
