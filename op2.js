...
words.style.backgroundImage="url(./make_tea/3.png)";
setTimeout("background_change(3)", 3000);    
op_move1(1);
op_move2(2);
...
function op_move1(n) {
    ...
    op.addEventListener("touchstart", (e) => {
        ...
        op1.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + mouse_startY + "px;left: " + mouse_startX + "px;background-image: url(./make_tea/chanian.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
        ...
        op1.addEventListener("touchend", (e) => {
            if (op1.offsetLeft > area.offsetLeft && op1.offsetTop > area.offsetTop) {
                if (op1.offsetLeft < area.offsetLeft + 40 && op1.offsetTop < area.offsetTop + 40) {
                    ...
                    op2.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + thingY + "px;left: " + thingX + "px;background-image: url(./make_tea/chanian.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
                    bg.appendChild(op2);
                    dragflag[n] = 1;
                }
            }
...
function op_move2(n) {
    ...
    op.addEventListener("touchstart", (e) => {
        ...
        op.style.display = "none";
        big_box.style.display = "block";
        op01.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + mouse_startY + "px;left: " + mouse_startX + "px;background-image: url(./make_tea/chamo1.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
        ...
        op01.addEventListener("touchend", (e) => {
            if (op01.offsetLeft > area.offsetLeft && op01.offsetTop > area.offsetTop) {
                if (op01.offsetLeft < area.offsetLeft + 40 && op01.offsetTop < area.offsetTop + 40) {
                    ...
                    big_box.style.display = "none";
                    op02.style.cssText = "z-index:999; width: 30%;height: 30vw;position: absolute;top: " + thingY + "px;left: " + thingX + "px;background-image: url(./make_tea/chamo1.png);background-position: center;background-repeat: no-repeat;background-size: contain;";
                    bg.appendChild(op02);
                    dragflag[n] = 1;
                    black.style.display="block";
                    show.style.backgroundImage = "url(./make_tea/3niancha.gif)";
